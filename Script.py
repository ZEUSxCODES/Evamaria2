...
✯ Mʏ Vᴇʀꜱɪᴏɴ: BQ ᴠ4.5.0</b>"""
    SOURCE_TXT = """<b>𝐖𝐚𝐧𝐭 𝐌𝐨𝐯𝐢𝐞𝐬, 𝐒𝐨 𝐓𝐲𝐩𝐞 𝐋𝐢𝐤𝐞 𝐓𝐡𝐢𝐬👇
...
ɪꜰ ᴍᴏᴠɪᴇꜱ ɪꜱ ʀᴇʟᴇᴀꜱᴇᴅ ʙᴜᴛ ɴᴏᴛ ɢᴇᴛᴛɪɴɢ ɪᴛ ꜱᴏ ᴛʏᴘᴇ ᴡɪᴛʜ #Request .</b>  
...
- FilmNest_bot Supports both url and alert inline buttons.

<b>NOTE:</b>
1. Telegram will not allows you to send buttons without any content, so content is mandatory.
2. FilmNest_bot supports buttons with any telegram media type.
...
<b>NOTE:</b>
these are the extra features of FilmNest_bot
